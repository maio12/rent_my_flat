...
greg_apart1 = Apartment.create(title: "Beautiful apartment in Pittsburg", address: "26 Sarah street", user: gregory)
greg_apart2 = Apartment.create(title: "Beautiful apartment in Columbus", address: "62 Frankleen street", user: gregory)
gin_apart1 =Apartment.create(title: "Beautiful apartment in London", address: "1 ormonde gate", user: ginevra)
gin_apart2 =Apartment.create(title: "Beautiful apartment in Rome", address: "via margutta 54", user: ginevra)
